    ...
    switch ($selection) {
        ...
        '2' {
            ...
            foreach ($id in $idList) {
                ...
                # 构建下载URL
                $url = "https://codeload.github.com/SteamAutoCracks/ManifestHub/zip/refs/heads/$id"
        ...
        '3' {
            ...
            # 先执行功能2的操作（下载并处理文件）
            Write-Host "`n下载并处理文件..."
            $url = "https://codeload.github.com/SteamAutoCracks/ManifestHub/zip/refs/heads/$appId"
